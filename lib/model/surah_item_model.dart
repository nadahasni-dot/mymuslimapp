...
SurahItemModel surahItemModelFromJson(String str) =>
    SurahItemModel.fromJson(json.decode(str));

String surahItemModelToJson(SurahItemModel data) => json.encode(data.toJson());
...
class SurahItemModel {
  ...
  factory SurahItemModel.fromJson(Map<String, dynamic> json) => SurahItemModel(
        code: json["code"],
        status: json["status"],
